...
def main(retriever_name: str, test_file: str, output_file: str, k: int, in_language: bool, checkpoint: str):
    in_language = False
    tokenizer = AutoTokenizer.from_pretrained(checkpoint)
    try: model   = AutoModelForSeq2SeqLM.from_pretrained(checkpoint, torch_dtype="auto", device_map="auto")
    except: model = AutoModelForCausalLM.from_pretrained(checkpoint, torch_dtype="auto", device_map="auto")
